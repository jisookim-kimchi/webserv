...
{   
    ...
    */
    ...
    /*
    set + socket + option : config socket options.
    @param 1 : socket descriptor
    @param 2 : socket level : SOL_SOCKET - socket options
    @param 3 : socket option : SO_REUSEADDR - reuse address
    @param 4 : option value : 1 - enable reuse address
    @param 5 : option value size
